...
import com.example.bankingapp.Adapters.SendToUserAdapter;
...
public class SendUser extends AppCompatActivity
{
    ...
    private void showData(String phonenumber)
    {
        ...
        adapter = new SendToUserAdapter(SendUser.this, modelList_sendtouser);
    ...
    public void selectuser(int position)
    {
        ...
        while(cursor.moveToNext())
        {
            ...
            calculateAmount();
            startActivity(new Intent(SendUser.this, SuccessSplashScreen.class));
    ...
    {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(SendUser.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", (dialogInterface, i) -> {
                    new DatabaseHelper(SendUser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                    Toast.makeText(SendUser.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(SendUser.this, MainActivity.class));
                    finish();
